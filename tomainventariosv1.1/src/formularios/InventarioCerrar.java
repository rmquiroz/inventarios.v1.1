...
public class InventarioCerrar extends JFrame {
	...
	public InventarioCerrar() {
		...
		MP_PLANTA_1C.setBounds(23, 375, 168, 23);
		...
		btnAceptar.addActionListener(new ActionListener() {
			...
			if(BRANDSEUA.isSelected() || UDMP.isSelected() || QUIMICOS.isSelected() || MPPLANTA.isSelected() ||
					 MPPLANTAB.isSelected() || MP_PLANTA2D.isSelected() || SMO_J1_PT.isSelected() || 
					 SMO_MATERIA.isSelected() || ETIQUETAS.isSelected() || MP_PLANTA_1C.isSelected()){
				almacenes="";
